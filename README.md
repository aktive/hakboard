...
- **USAGE:** From your HA dashboard, select `Edit` (top right), `+ Add Card` (bottom right), choose any type of card then select `Show code editor` (bottom left) and paste the contents of [lovelace_card_users.yaml](https://github.com/aktive/hakboard/blob/main/custom_components/hakboard/lovelace_card_users.yaml). It will automatically detect all relevant `hakboard.` user entities and display them on the card.
...
- **USAGE:** From your HA dashboard, select `+ Add Card`, choose any type of card then select `Show code editor` (bottom left) and paste the contents of  [lovelace_card_projects.yaml](https://github.com/aktive/hakboard/blob/main/custom_components/hakboard/lovelace_card_projects.yaml). It will automatically detect all relevant `hakboard.` project entities and display them on the card.
